...
graph = (
    ...
    .add_node("detect_language", detect_language)
    ...
    .add_edge("initialize_turn", "detect_language")
    .add_edge("detect_language", "router")
    ...
    # RAG → Retrieve judge → generate or rewrite
    ...
    # generate → hallucination judge → resolve
    .add_conditional_edges(
        "generate",
        judge_factfullness,
        {
