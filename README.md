...
본 프로젝트는 디지털 선교 현장에서의 인력 부족 문제, 응답 지연, 정서적 소진, 악성 사용자 대응 문제 등을 해결하기 위해 개발된 AI 기반 전도 챗봇 시스템입니다.
특히 연간 30,000명 이상의 신규 유입자를 10~20명의 사역자가 감당해야 하는 Last Call 플랫폼의 실제 문제를 해결하기 위한 실무형 AI 솔루션으로 설계되었습니다.
...
⚠️ API Key와 DB 정보는 실제 배포 환경에서는 GitHub에 절대 노출하지 마세요.
...
아래와 같이 LangChain의 ChatModel 부분만 변경하면 OpenAI / Claude / Gemini / Local LLM 등으로 쉽게 교체할 수 있습니다.
...
즉, LLM 교체는 1줄만 바꾸면 가능하도록 구조화되어 있습니다.
...
평가는 evaluation/finaltest_with_ragas.ipynb에서 실행할 수 있습니다.
